...
define(`uinclude', `syscmd(cat $1)')dnl
...
define(`toupper', `translit($1, LOWER, UPPER)')dnl
dnl the actual start of the library: the name
define(`name', `define(`NAME', $1)'/* $1 ) dnl
...
define(`GUARD_NAME', `toupper(NAME)H_INCLUDE')dnl
...
define(`guard_end', `#endif /* !defined(GUARD_NAME) */')dnl
dnl a bit of code to provide us with UNUSED....
define(`unused_start', `syscmd(`sed s/UNUSED/SHL_UNUSED/g <unused.h.in')')dnl
...
dnl
dnl Macro to handle the common cases, to make the individual files even simpler
